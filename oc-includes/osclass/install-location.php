...
/*
 * Changes:
 * Deleted osclass.org links in e-mail installation template. Added osclass.pro and 4osclass.net links.
 */
...
function basic_info() {
    ...
    $body .= '</ul>';
    $body .= sprintf(__('Remember that for any doubts you might have you can consult our <a href="%1$s">documentation</a>, <a href="%2$s">forum</a> or <a href="%3$s">blog</a>.'), 'https://osclass.pro/dokumentaciya/', 'https://4osclass.net/', 'https://osclass.pro/');
    $body .= sprintf(' ' . __('Osclass doesn’t run any developments but we can put you in touch with third party developers through a Premium Support. And hey, if you would like to contribute to Osclass - learn how <a href="%1$s">here</a>!'), 'https://osclass.pro/') . '<br/><br/>';
...
function install_locations ( ) {
    ...
    if($country!='all') {
		...
		$data_sql = file_get_contents( ABS_PATH . 'oc-includes/osclass/installer/RU-Russia.sql' );
