 ...
 * Deleted code and urls for registration in Osclass Market. Advertisement of Hosting removed.						  
 */
    ...
    <form id="target_form" name="target_form" action="#" method="post" onsubmit="return false;">
        ...
        <div class="form-table">
            ...
            <div id="location">
						...
						<input type="hidden" id="country-input" name="country-input" value="ruloc" />
						<div id="location-error">
						<?php _e('При установке будет добавлена Россия с регионами и городами. Позже Вы сможете добавлять другие страны, редактировать или удалять.'); ?>
						</div>
            </div>
        </div>
        <div class="clear"></div>
