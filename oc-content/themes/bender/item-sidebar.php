    ...
    <div id="contact" class="widget-box form-container form-vertical">
        ...
        <?php } else if( osc_reg_user_can_contact() && !osc_is_web_user_logged_in() ) { ?>
            ...
            <p class="contact_button">
                <strong><a data-fancybox href="#login" class="btn btn-white"><?php _e('Login', 'bender'); ?></a></strong>
                <strong><a data-fancybox href="#reg" class="btn btn-yellow"><?php _e('Register for a free account', 'bender'); ?></a></strong>
            </p>
        <?php } else { ?>
            ...
            <form action="<?php echo osc_base_url(true); ?>" method="post" name="contact_form" id="contact_form" <?php if(osc_item_attachment()) { echo 'enctype="multipart/form-data"'; };?> >
                ...
                <div class="control-group">
                    <label class="control-label" for="phoneNumber"><?php _e('Phone number', 'bender'); ?>:</label>
                ...
                <div class="control-group">
                    <div class="controls">
                        ...
                        <button type="submit" class="btn btn-yellow ui-button ui-button-middle ui-button-main"><?php _e("Send", 'bender');?></button>
                    </div>
                </div>
            </form>
