            ...
            <div class="resp-wrapper">
                <form name="login" id="login" action="<?php echo osc_base_url(true); ?>" method="post">
                    ...
                    <div class="control-group">
                        <label class="control-label" for="phone"><?php _e('Номер телефона', 'bender'); ?></label>
                        <div class="controls">
                            <?php UserForm::s_phone_mobile(); ?>
                        </div>
                    </div>
                    <div class="control-group">
                        <label class="control-label" for="password"><?php _e('Код', 'bender'); ?></label>
                        <div class="controls">
                            <?php UserForm::s_phone_land(); ?>
                        </div>
                    </div>
