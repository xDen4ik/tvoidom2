 ...
 * Deleted error message in start installation.
 */
...
if( !file_exists(ABS_PATH . 'config.php') ) {
    ...
    $title   = 'Osclass';
    $message = '<p><a class="button" href="' . osc_get_absolute_url() .'oc-includes/osclass/install.php">Установить</a></p>';
...
if( !getBoolPreference('osclass_installed') && MULTISITE ) {
    ...
    $message  = 'Osclass не установлен. <a href="https://4osclass.net/">Нужна помошь?</a></p>';
